...
class AdminUserFilter implements FilterInterface
{
    use ResponseTrait;
    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        try {
            ...
            // Periksa apakah token yang didekode memiliki peran 'petugas' || 'pengawas'
            if (!property_exists($decoded, 'role') || $decoded->role !== 'petugas' && $decoded->role !== 'pengawas') {
